...
const FlightDetails = () => {
  ...
  const generateMockWeather = (flightData) => {
    const weatherData = {
      departure: {
        ...
        condition: ["Sunny", "Partly Cloudy", "Clear"][
      ...
      arrival: {
        ...
        condition: ["Cloudy", "Partly Cloudy", "Light Rain"][
          Math.floor(Math.random() * 3)
        ],
  ...
  const calculateDelayRisk = () => {
    ...
    const windDiff = Math.abs(
      weather.departure.windSpeed - weather.arrival.windSpeed,
    );
    let riskLevel = "LOW";
    let color = "green";
    let probability = "15%";
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                          ...
                          <span className="font-semibold">
                            {flight.aircraft || "Airbus A320neo"}
                          </span>
                        </div>
                        <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                          <span className="text-gray-600 dark:text-gray-400">
                        ...
                        <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                          ...
                          <span className="font-semibold">
                            {flight.checkInTime || "2 hours before departure"}
                          </span>
                        </div>
                        <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                          <span className="text-gray-600 dark:text-gray-400">
                ...
                {activeTab === "amenities" && (
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {flight.amenities?.map((amenity, index) => (
                      <div
                        key={index}
                        className="flex flex-col items-center justify-center p-4 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-700"
                      >
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div
                    className={`px-3 py-1 rounded-full text-xs font-bold ${
                      delayRisk.color === "green"
                        ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400"
                        : delayRisk.color === "yellow"
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl shadow-xl p-6 text-white">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold">
                    ₹{(flight.price * 0.18).toLocaleString()}
                  </span>
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-blue-500/30">
                <div className="flex items-center justify-center gap-2 text-sm text-blue-200">
                  ...
                  <span>
                    Secure payment • 24/7 Support • Free cancellation within 24h
                  </span>
                </div>
              </div>
            </div>
