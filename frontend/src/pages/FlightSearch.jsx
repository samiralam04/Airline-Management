...
const FlightSearch = () => {
  ...
  const handleInitialSearch = () => {
    setLoading(true);
    setTimeout(() => {
      const mocks = generateMockFlights(
        searchParams.origin,
  ...
  const handleBookClick = (flight) => {
    navigate(`/booking/confirm/${flight.id}`, {
            ...
            {!loading && searched && flights.length === 0 ? (
              ...
              <div className="space-y-4">
                {flights.map((flight) => (
                  <div
                    key={flight.id}
                    className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl border border-gray-200 dark:border-gray-700 transition-all duration-300 overflow-hidden group"
                  >
                    <div className="p-6">
                        ...
                        <div className="flex items-center lg:w-1/5">
                          <div className="relative">
                            <div
                              ...
                              style={{
                                backgroundColor: flight.airlineColor + "10",
                                borderColor: flight.airlineColor + "30",
                              }}
                            >
                              <img
                            ...
                            <div className="flex-1 px-8">
                              <div className="relative">
                                ...
                                <div className="flex justify-between mt-2 text-xs text-gray-500 dark:text-gray-400">
                                  <span>
                                    {flight.isConnecting ? "1 Stop" : "Direct"}
                                  </span>
          ...
          <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-xl border border-blue-100 dark:border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                ...
                Consider refundable tickets for changes
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-400">
                <span className="font-semibold text-gray-800 dark:text-white">
                  Baggage:
