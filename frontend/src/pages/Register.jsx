...
const Register = () => {
  ...
  const handleSocialLogin = (provider) => {
    ...
    setMessage(
      `error:${provider} login requires backend OAuth2 configuration.`,
    );
  };
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg">
                Create your account to unlock exclusive flight deals, manage
                bookings, and earn rewards with every journey.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      Get 500 bonus miles on your first booking
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      Free cancellation on most flights
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 p-8 md:p-12 flex flex-col justify-center">
          ...
          <form className="space-y-6" onSubmit={handleRegister}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {[
                  ...
                  <div key={index} className="flex items-center gap-2">
                    <div
                      className={`w-4 h-4 rounded-full flex items-center justify-center ${req.valid ? "bg-green-100" : "bg-gray-100"} dark:${req.valid ? "bg-green-900/30" : "bg-gray-700"}`}
                    >
                      {req.valid ? (
                    ...
                    <span
                      className={`text-sm ${req.valid ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}
                    >
                      {req.label}
                    </span>
                  </div>
            ...
            {message && (
              <div
                className={`p-4 rounded-xl border ${isError ? "bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800" : "bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800"}`}
              >
                <div className="flex items-center gap-3">
                  {isError ? (
                  ...
                  <span
                    className={`font-medium ${isError ? "text-red-800 dark:text-red-300" : "text-green-800 dark:text-green-300"}`}
                  >
                    {displayMessage}
                  </span>
                </div>
