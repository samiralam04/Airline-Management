...
const BookingConfirm = () => {
  ...
  const fareBreakdown = {
    ...
    classMultiplier:
      passenger.flightClass === "Business"
        ? 1.8
        : passenger.flightClass === "First"
          ? 2.5
          : 1,
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between relative max-w-3xl mx-auto">
            ...
            <div
              className="absolute top-1/2 left-0 h-1 bg-gradient-to-r from-blue-500 to-green-500 -z-10 transform -translate-y-1/2 transition-all duration-500"
            ...
            {[1, 2, 3].map((stepNum) => (
              <div key={stepNum} className="flex flex-col items-center">
                ...
                <span
                  className={`mt-3 text-sm font-semibold ${step >= stepNum ? "text-gray-900 dark:text-white" : "text-gray-400"}`}
                >
                  {stepNum === 1
                    ? "Details"
                    : stepNum === 2
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-400 mt-1">
                      {flight.isConnecting ? "1 Stop" : "Non-stop"}
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-gray-900 dark:text-white">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 border border-blue-100 dark:border-gray-700">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400">
                Your payment details are protected with 256-bit encryption. We
