  ...
  const tips = [
    {
      ...
      content:
        "Roll your clothes to save space and prevent wrinkles. Always keep essential items in your carry-on in case of lost luggage.",
      icon: (
        <svg
    ...
    },
    {
      ...
      content:
        "Always get travel insurance. It covers unexpected cancellations, medical emergencies, and lost belongings.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      content:
        "Research local customs and etiquette before you go. A little respect goes a long way in making connections.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
