...
const FeaturedDestinations = () => {
    ...
    const destinations = [
        ...
        },
        {
            ...
            description: "Discover the perfect blend of tradition and futuristic technology."
        },
        {
            id: 3,
            city: "New York",
        ...
        },
        {
            ...
            country: "UAE",
            price: "₹60,000",
            image: "https://img.veenaworld.com/group-tours/world/dubai-egypt-israel/meza/meza-thb-meza-12112022.jpg?imWidth=300",
            description: "Witness the architectural marvels and luxury of the desert."
        },
        {
            id: 5,
            city: "Sydney",
            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
                        Explore our most popular destinations at unbeatable prices. Your next adventure is just a click away.
                    </p>
                </div>
